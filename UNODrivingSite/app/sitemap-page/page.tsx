                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/sitemap-page" className="hover:text-primary">Sitemap</Link></li>
                        </ul>
                    </div>
                    ...
                    {Object.entries(locations).map(([region, suburbs]) => (
                        <div key={region}>
                            ...
                            <ul className="space-y-2">
                                ...
                                {suburbs.map((suburb) => (
                                    <li key={suburb}>
                                        <Link href={`/locations/${suburb.toLowerCase().replace(/ /g, "-")}`} className="hover:text-primary text-sm text-gray-600">
                                            {suburb}
                                        </Link>
                                    </li>
                                ))}

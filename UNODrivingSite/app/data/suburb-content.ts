...
export const suburbContent: Record<string, SuburbContent> = {
    ...
    "bowen-hills": {
        ...
        description: [
            "Navigate the busy intersections of Bowen Hills with ease. We’ll teach you how to handle heavy traffic flows, complicated lane changes, and the busy areas around the Inner City Bypass entrances.",
    ...
    "new-farm": {
        ...
        description: [
            "Enjoy the leafy avenues of New Farm while learning to drive. We focus on sharing the road safely with cyclists and pedestrians near New Farm Park and navigating the busy James Street precinct.",
    ...
    "paddington": {
        ...
        description: [
            ...
            "Learn to manage the busy boutique strips and complex intersections near Caxton Street. Our instructors focus on gap selection and hazard perception in this active area.",
    ...
    "west-end": {
        ...
        description: [
            "Discover the eclectic streets of West End. From the busy Boundary Street to the riverside curves of Orleigh Park, we teach you to watch for pedestrians, cyclists, and unexpected hazards.",
    ...
    "albion": {
        ...
        description: [
            ...
            "From the steep inclines of the residential streets to the busy arterial roads, Albion offers a comprehensive environment to refine your driving skills."
        ],
    ...
    "ferny-grove": {
        ...
        description: [
            "Start your driving experience at the end of the line in Ferny Grove. Learn to handle the traffic around the train station and local schools.",
    ...
    "keperra": {
        ...
        description: [
            "Conquer the hills of Keperra driving. We emphasize confidence of hill starts and speed control on gradients near Samford Road.",
    ...
    "newmarket": {
        ...
        description: [
            "Drive the active streets of Newmarket. We teach you to handle the busy Enoggera Road and the traffic around Newmarket Village.",
    ...
    "nundah": {
        ...
        description: [
            "Conquer the busy roads of Nundah. We teach you to navigate the Nundah Tunnel access points and the busy Sandgate Road intersections.",
    ...
    "virginia": {
        ...
        description: [
            ...
            "Our instructors help you interpret complex signage and manage traffic flow in this busy area."
        ],
    ...
    "durack": {
        ...
        description: [
            ...
            "We focus on defensive driving techniques to keep you safe on the busy Blunder Road.",
    ...
    "inala": {
        ...
        description: [
            ...
            "We focus on observation and awareness of pedestrians in this busy community hub.",
    ...
    "kingston": {
        ...
        description: [
            "Master the busy streets of Kingston. Learn to navigate the busy Kingston Road and the traffic around the train station.",
    ...
    "bulimba": {
        ...
        description: [
            "Master the busy streets of Bulimba. Learn to handle the high pedestrian activity on Oxford Street and the tight parking situations.",
    ...
    "wynnum": {
        ...
        description: [
            "Experience the coastal driving of Wynnum. Learn to handle the busy town centre, railway crossings, and the esplanade.",
